...
//http://localhost:8080//rest/ciudad/list
@Path("ciudad")
public class CiudadRest {
	@EJB
	CiudadSession cs;//Inyeccion de dependencias

//GET http://localhost:8080/BIBLIOTECA-WEB/rest/ciudad/list
	@GET
...
//GET http://localhost:8080/BIBLIOTECA-WEB/rest/ciudad/find/n
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/find/{codigo}")
...
//PUT http://localhost:8080/BIBLIOTECA-WEB/rest/ciudad/update
	@PUT	//Verbo //Method
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/update")
...
//DELETE http://localhost:8080/BIBLIOTECA-WEB/rest/ciudad/delete/n
	@DELETE
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/delete/{codigo}")
