...
public class UsuarioRest {
	...
	//GET http://localhost:8080/BIBLIOTECA-WEB/rest/usuario/list
		@GET
	...
	//GET http://localhost:8080/BIBLIOTECA-WEB/rest/usuario/find/n
		@GET
		@Produces(MediaType.APPLICATION_JSON)
		@Path("/find/{codigo}")
	...
	//PUT http://localhost:8080/BIBLIOTECA-WEB/rest/usuario/update
		@PUT
		@Produces(MediaType.APPLICATION_JSON)
		@Path("/update")
	...
	//DELETE http://localhost:8080/BIBLIOTECA-WEB/rest/usuario/delete/n
		@DELETE
		@Produces(MediaType.APPLICATION_JSON)
		@Path("/delete/{codigo}")
